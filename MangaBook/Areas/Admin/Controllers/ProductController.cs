...
namespace MangaWEB.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        {
            var imageToBeDetleted = _unitOfWork.ProductImage.Get(u => u.Id == imageId);
            int productId = imageToBeDetleted.ProductId;
            if(imageToBeDetleted !=null)
            {
                if(!string.IsNullOrEmpty(imageToBeDetleted.ImageUrl))
                {
                    var oldImagePath = Path.Combine(_webHostEnvironment.WebRootPath, imageToBeDetleted.ImageUrl.TrimStart('\\'));
                ...
                _unitOfWork.ProductImage.Remove(imageToBeDetleted);
                _unitOfWork.Save();
        ...
        public IActionResult Delete(int? id)
        {
            ...
            _unitOfWork.Product.Remove(productsToBeDeleted)
;
            _unitOfWork.Save();
